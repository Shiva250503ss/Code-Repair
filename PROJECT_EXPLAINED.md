...
This guide explains every real file in Parts A, B, C, and F. For each file:
what it does, why it is built that way, what to say out loud in an
interview, and likely follow-up questions with short answers. The language
